...
╚═════╝  ╚═════╝ ╚═╝     ╚═╝╚═════╝ ╚═╝╚═╝  ╚═══╝ ╚═════╝   \033[94m   │".center(columns+15))
    ...
    print("\033[94m│ \033[95mAuthor : 𝐦𝐑. 𝐬𝐇𝐚𝐤𝐢𝐋 𝐯𝐚𝐔                     \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Bd SMS Bombing          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : https://www.facebook.com/shakil.vau404 \033[94m│".center(columns+9))
    print("│ \033[95mGithub :https://www.facebook.com/shakil.vau404              \033[37mV3.0 \033[94m│".center(columns+15))
    print("\033[94m└────────────────────────────────────────┘".center(columns+5))
